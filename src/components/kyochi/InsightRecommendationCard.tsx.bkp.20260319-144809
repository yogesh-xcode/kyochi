  ...
  return (
    <section className="k-surface rounded-xl border k-border-soft shadow-sm p-4 h-full flex flex-col">
      ...
      <div className="flex flex-col sm:flex-row xl:flex-col gap-1.5 mt-auto">
        <button className="w-full sm:w-auto xl:w-full px-3 py-1.5 rounded-xl bg-[var(--kyochi-gold-500)] text-[var(--kyochi-cream-100)] type-small font-bold hover:bg-[var(--kyochi-gold-600)] transition-colors">
          {primaryAction}
        </button>
